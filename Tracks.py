...
target_url = 'https://demo-widget.yupl.us/IRCTC/train_list.html'  # starting url
...
def findalllinks(url):
    ...
    res = requests.get("https://demo-widget.yupl.us/IRCTC/train_list.html")  # takes the string of the url to download
...
def pagehits(url):
    ...
    browser = webdriver.Chrome("/Users/apple/PycharmProjects/Analytics_Event/Config/chromedriver")
    browser.get(url)
...
url_list = findalllinks("https://demo-widget.yupl.us/IRCTC/train_list.html")
